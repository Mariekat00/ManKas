    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="owner_name" class="control-label">Votre nom complet</label>
                    <input type="text" name="owner_name" id="owner_name" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="contact" class="control-label">Numéro téléphone</label>
                ...
                <div class="form-group">
                    <label for="address" class="control-label">Votre Addresse</label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">Numero d'enregistrement Vehicle</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">Modele du Vehicle</label>
                ...
                <div class="form-group">
                    <label for="service_type" class="control-label">Type de demande</label>
                    <select name="service_type" id="service_type" class="form-select form-select-sm select2 rounded-0" required>
                        <option>Déposer</option>
                        <option>rendere</option>
                    </select>
                </div>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Envoyer la commande</button>
                <button class="btn btn-dark btn-sm rounded-0" type="button" data-dismiss="modal">Annuler</button>
            </div>
        </div>
    </form>
</div>
<script>
    $(function(){
        $('.select2').select2({
            placeholder:"S'il vous plaît séléctionner ici",
