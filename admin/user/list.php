...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Liste de utilusateur du systhème</h3>
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Crréer un nouveau</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Etes vous sure de supprimer cet utilusaté pérmanent?","delete_user",[$(this).attr('data-id')])
		})
		$('.table').dataTable();
	})
