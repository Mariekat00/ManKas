...
<div class="col-lg-12">
	<div class="card card-outline card-primary">
		<div class="card-header">
			<h5 class="card-title">Information du Système</h5>
		...
		<div class="card-body">
			...
			<div class="form-group">
				<label for="" class="control-label">A propos de nous</label>
			...
			<div class="form-group">
				...
				<div class="custom-file">
	              ...
	              <label class="custom-file-label" for="customFile">Choisissez l'image</label>
	            </div>
			</div>
		...
		<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary" form="system-frm">Mise à jour</button>
				</div>
			</div>
		</div>
