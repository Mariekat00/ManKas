...
<div class="card card-outline card-info">
	<div class="card-header">
		<h3 class="card-title"><?php echo isset($id) ? "Update ": "Create New " ?>Créer le paquet</h3>
	</div>
	<div class="card-body">
		<form action="" id="package-form">
			<input type="hidden" name ="id" value="<?php echo isset($id) ? $id : '' ?>">
			<div class="form-group">
				<label for="title" class="control-label">Titre du Paquet</label>
	...
	<div class="card-footer">
		...
		<a class="btn btn-flat btn-default" href="?page=maintenance">Annuler</a>
	</div>
</div>
<script>
