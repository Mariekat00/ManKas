...
<div class="container-fluid">
    ...
    <div class="col-12">
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="category_id" class="control-label">Type du Vehicle</label>
                ...
                <div class="form-group">
                    <label for="owner_name" class="control-label">Nom complet Propriétaire</label>
                ...
                <div class="form-group">
                    <label for="contact" class="control-label">Contact Propriétaire #</label>
                ...
                <div class="form-group">
                    <label for="email" class="control-label">Email Propriétaire</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="vehicle_name" class="control-label">Nom du Vehicle</label>
                ...
                <div class="form-group">
                    <label for="vehicle_registration_number" class="control-label">Numero d'incription du Vehicle</label>
                ...
                <div class="form-group">
                    <label for="vehicle_model" class="control-label">ModèleVehicle</label>
                ...
                <div class="form-group">
                    <label for="service_type" class="control-label">Type de commande Type</label>
                    <select name="service_type" id="service_type" class="form-select form-select-sm select2 rounded-0" required>
                        <option <?php echo isset($service_type) && $service_type == 'Drop Off' ? "selected" : '' ?>>A domicil</option>
                        <option <?php echo isset($service_type) && $service_type == 'Pick Up' ? "selected" : '' ?>>Deposer</option>
                    </select>
                </div>
                <div class="form-group" <?php echo isset($service_type) && $service_type == 'Drop Off' ? 'style="display:none"' : '' ?>>
                    <label for="pickup_address" class="control-label">Adresse de prender</label>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group " id="mechanic-holder">
                    <label for="mechanic_id" class="control-label">Affecté à:</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                        ...
                        <option value="1" <?php echo isset($status) && $status == 1 ? "selected" : '' ?>>Confirmé</option>
                        <option value="2" <?php echo isset($status) && $status == 2 ? "selected" : '' ?>>En cours</option>
                        <option value="3" <?php echo isset($status) && $status == 3 ? "selected" : '' ?>>Términé</option>
                        <option value="4" <?php echo isset($status) && $status == 4 ? "selected" : '' ?>>Annulé</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="w-100 d-flex justify-content-end mx-2">
            <div class="col-auto">
                <button class="btn btn-primary btn-sm rounded-0">Enregistrer la commade</button>
                <button class="btn btn-light btn-sm rounded-0" type="button" data-dismiss="modal">Fermer</button>
            </div>
        </div>
    </form>
</div>
