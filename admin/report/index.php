...
<div class="card card-primary card-outline">
    <div class="card-header">
        <h5 class="card-title">Rapport des commandes</h5>
    </div>
    <div class="card-body">
        <form id="filter-form">
            <div class="row align-items-end">
                ...
                <div class="form-group col-md-3">
                    <label for="date_start">Date de fin</label>
                ...
                <div class="form-group col-md-2">
                    <button class="btn btn-flat btn-block btn-success btn-sm" type="button" id="printBTN"><i class="fa fa-print"></i> Imprimer</button>
                </div>
            </div>
        </form>
        <hr>
        <div id="printable">
            <div>
                ...
                <h3 class="text-center m-0"><b>Rapport des commandes</b></h3>
                <p class="text-center m-0">Date entre <?php echo $date_start ?> et <?php echo $date_end ?></p>
                <hr>
            </div>
            <table class="table table-bordered">
                ...
                <thead>
                    <tr>
                        ...
                        <th>Nom du Vehicle</th>
                        <th>N° Enreg. Vehicle</th>
                        <th>Affecté à</th>
                        <th>Service</th>
                        <th>Status</th>
                    </tr>
