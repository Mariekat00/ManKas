  ...
  <div class="container px-4 px-lg-5 ">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
        ...
        <li class="nav-item"><a class="nav-link" aria-current="page" href="./?p=contact">Contact</a></li>
        <li class="nav-item"><a class="nav-link" href="./?p=about">A propos</a></li>
      </ul>
      <a class="nav-link btn btn-dark col-auto" style="color:white" id="ManKas" href="./?p=loginAdm" target="_blank">Admin</a>
